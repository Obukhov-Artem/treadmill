...
# линейный алгоритм с дополнительным сокращением безопасной зоны
def alg_lin_2(z):
    global moving
    max_speed = 255
    tr_len = 1
...
# использование нейронной сети + алгоритмические коррективы для лучшей работы
...
# разбиение по массивам - тело, ноги
print(data.shape)
body_z = data[:, 2]
body_dz = data[:, 8]
